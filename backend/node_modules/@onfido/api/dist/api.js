...
exports.DeviceIntelligencePropertiesDeviceSdkSourceEnum = {
    AndroidSdk: 'onfido-android-sdk',
    IosSdk: 'onfido-ios-sdk',
    WebSdk: 'onfido-web-sdk',
    UnknownDefaultOpenApi: '11184809'
};
exports.DeviceIntelligencePropertiesDeviceAuthenticationTypeEnum = {
    SdkToken: 'sdk_token',
    MobileToken: 'mobile_token',
    ApiToken: 'api_token',
    UnknownDefaultOpenApi: '11184809'
};
exports.DeviceIntelligencePropertiesDeviceIpReputationEnum = {
    NotEnoughData: 'NOT_ENOUGH_DATA',
    HighRisk: 'HIGH_RISK',
    LowRisk: 'LOW_RISK',
    UnknownDefaultOpenApi: '11184809'
};
exports.DeviceIntelligencePropertiesDeviceDocumentCaptureEnum = {
    Live: 'live',
...
exports.DocumentPropertiesWithDrivingLicenceInformationHasIssuanceConfirmationEnum = {
    True: 'true',
    False: 'false',
    Unspecified: 'unspecified',
    UnknownDefaultOpenApi: '11184809'
};
exports.DocumentPropertiesWithDrivingLicenceInformationSecurityTierEnum = {
    Tier1: 'tier_1',
    Tier2: 'tier_2',
    Tier3: 'tier_3',
    Tier4: 'tier_4',
 ...
 */
exports.WebhookEventResourceStatus = {
    Processing: 'processing',
    AwaitingInput: 'awaiting_input',
    AwaitingClientInput: 'awaiting_client_input',
    Approved: 'approved',
...
const DefaultApiAxiosParamCreator = function (configuration) {
    return {
        ...
        cancelReport: (reportId, options = {}) => __awaiter(this, void 0, void 0, function* () {
            ...
            // oauth required
            yield (0, common_1.setOAuthToObject)(localVarHeaderParameter, "OAuth2ClientCredentials", [], configuration);
         ...
         * @throws {RequiredError}
         */
        listWorkflowRuns: (page, status, createdAtGt, createdAtLt, sort, applicantId, tags, options = {}) => __awaiter(this, void 0, void 0, function* () {
            const localVarPath = `/workflow_runs`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new url_1.URL(localVarPath, common_1.DUMMY_BASE_URL);
            let baseOptions;
...
const DefaultApiFp = function (configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        listWorkflowRuns(page, status, createdAtGt, createdAtLt, sort, applicantId, tags, options) {
            var _a, _b, _c;
            return __awaiter(this, void 0, void 0, function* () {
                const localVarAxiosArgs = yield localVarAxiosParamCreator.listWorkflowRuns(page, status, createdAtGt, createdAtLt, sort, applicantId, tags, options);
                const localVarOperationServerIndex = (_a = configuration === null || configuration === void 0 ? void 0 : configuration.serverIndex) !== null && _a !== void 0 ? _a : 0;
...
class DefaultApi extends base_1.BaseAPI {
     ...
     */
    listWorkflowRuns(page, status, createdAtGt, createdAtLt, sort, applicantId, tags, options) {
        return (0, exports.DefaultApiFp)(this.configuration).listWorkflowRuns(page, status, createdAtGt, createdAtLt, sort, applicantId, tags, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Run a health check on the Onfido API
     * @summary Ping
